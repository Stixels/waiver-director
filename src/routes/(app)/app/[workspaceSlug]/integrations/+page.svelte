...
<PageHeader
	title="Booking provider connections"
	subtitle="Choose a booking provider for this workspace. Bookeo can be connected now; Resova, Xola, and FareHarbor are planned provider options."
/>
